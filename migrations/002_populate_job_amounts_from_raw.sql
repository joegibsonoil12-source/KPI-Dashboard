...
-- 
-- IMPORTANT: Run PREVIEW SELECT first before running this update:
--
-- WITH parsed AS (
--   SELECT
--     id,
...
INSERT INTO migrations.job_amount_update_log (job_number, job_date, old_job_amount, new_job_amount)
SELECT job_number, job_date, old_job_amount, new_job_amount FROM updated
RETURNING *;
